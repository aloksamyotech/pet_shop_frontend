...
import { TextField, IconButton, Box, Typography, Paper, Avatar, CircularProgress, Button } from '@mui/material';
...
const ChatGPTClone = () => {
  ...
  const { isRecording, startSpeechToText, stopSpeechToText, interimResult, results } = useSpeechToText({ continuous: false });
          ...
          components={{
            code({ inline, className, children }) {
              ...
              return !inline && match ? (
                ...
                <code style={{ backgroundColor: '#F5F5F5', padding: '2px 4px', borderRadius: '4px' }}>{children}</code>
              );
            }
          }}
        >
